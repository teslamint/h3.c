...
|---:|---|---|---|---|
| 1 | ready | P1 | Add stage-specific qualification diagnostics | A failed RESULT identifies `contract`, `receipt`, `compute_plan`, `load`, `placement`, or `prediction`; table-driven tests cover every stage; no receipt is written on failure. |
