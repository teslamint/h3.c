...
- Stub identity: `xcrun stub complete output`
...
- Pre-state: existing unqualified compiled directory
...
- Exit status: `0`
- Sanitized output: `ok`
- Post-state: fresh compiled directory replaces prior via swap; no append/temp
- Next invocation / compensation result: next rerun also exits 0
- Mechanism check: old marker absent and new complete marker present
