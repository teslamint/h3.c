...
- Pre-state: previous unqualified output removed
- Exact injection/command: `rm fixture output; /private/tmp/h3-u4-evidence-mearkrwn/compile/bin/xcrun coremlcompiler compile /private/tmp/h3-u4-evidence-mearkrwn/compile/ane.mlpackage /private/tmp/h3-u4-evidence-mearkrwn/compile/compiled`
- Exit status: `1`
- Sanitized output: `fresh compile`
- Post-state: stale marker absent; fresh mlmodelc exists
- Next invocation / compensation result: repeat after removal succeeds
- Mechanism check: absence of stale marker proves fresh directory, not append
