...
- Stub identity: `compiled abort-after-sample seam`
...
- Post-state: final and temp JSON absent
- Next invocation / compensation result: fresh command exits 0
- Mechanism check: abort occurs after odd sample and before final rename
