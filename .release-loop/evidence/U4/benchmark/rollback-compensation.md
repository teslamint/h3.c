...
- Exact injection/command: `unlink benchmark JSON`
- Exit status: `0`
- Sanitized output: `evidence deleted`
- Post-state: no product/model state changed
- Next invocation / compensation result: fresh run recreates evidence
- Mechanism check: only evidence path removed; model sentinel remains
