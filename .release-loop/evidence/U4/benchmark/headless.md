...
- Exact injection/command: `H3_ANE_TEST_METAL_SECONDS=1.0 H3_ANE_TEST_COREML_SECONDS=0.8 /Users/teslamint/workspace/h3.c/h3_ane_bench_test --backend ab --coreml-model /private/tmp/h3-u4-authoritative-uizkm1rc/benchmark/model.mlmodelc --warmup 2 --pairs 20 --output /private/tmp/h3-u4-authoritative-uizkm1rc/benchmark/ab.json < /dev/null`
- Exit status: `0`
...
- Post-state: complete 40-sample JSON exists
- Next invocation / compensation result: analyzer accepts artifact
- Mechanism check: flag-only execution exits 0 with closed stdin
